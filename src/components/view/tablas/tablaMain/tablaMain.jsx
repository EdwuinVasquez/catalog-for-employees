    ...
    try {
      ...
      let datosFiltrados = tablaContenido.filter(
        (tupla) =>
          tupla[0]["valor"]
            .toLowerCase()
            .includes(valueBuscador.toLowerCase()) ||
          tupla[1]["valor"].toLowerCase().includes(valueBuscador.toLowerCase())
      );
    ...
    <>
      <div className="tablaMain">
        <TablaCabezera
          ...
          header={header}
          body={body}
          buscador={buscadorNombre}
          titulo={buscadorTitulo}
          manejarClick={realizarBusqueda}
          oculto={oculto}
        ></TablaCabezera>
        <TablaCotenido
          ...
          contenido={
            contenidoFilter[0].length >= 2 ? contenidoFilter : tablaContenido
          }
        ></TablaCotenido>
      </div>
    </>
