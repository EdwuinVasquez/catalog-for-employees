      ...
      return (
        <>
          <div htmlFor="export-file" className="exportar">
            ...
            ></label>
            <input
              className="exportar__input"
              type="checkbox"
              id="export-file"
            />
            <div htmlFor="export-file" className="exportar__opciones">
              <label className="exportar__label  exportar__label--fir">
                Export As &nbsp; &#10140;
              </label>
              ...
              >
                {" "}
                <label className="exportar__label" id="toCSV">
                  {" "}
                  CSV <img src={csv} alt="" />
                </label>{" "}
              </CSVLink>
              <label
                className="exportar__label"
                id="toEXCEL"
                onClick={descargarEcxel}
              >
