...
export function OpcionMenu(props) {
  ...
  const subMenuClick = (e) => {
    ...
    if (e.target && e.target.tagName != "DIV")
      elementoPadre = e.target.parentNode;

    if (
      elementoPadre.nextElementSibling &&
      elementoPadre.nextElementSibling.tagName == "UL"
    ) {
  ...
  const iconoHtml = (key) => {
    switch (key) {
      ...
      case "HiBuildingStorefront":
        return (
          <HiBuildingStorefront className="opcion__icono"></HiBuildingStorefront>
        );
      case "AiFillAppstore":
      ...
      case "MdLocalGroceryStore":
        return (
          <MdLocalGroceryStore className="opcion__icono"></MdLocalGroceryStore>
        );
      case "MdWorkHistory":
  ...
  return (
    <>
      <li
        className={
          "opcion__menu  " + (props.opciones ? "opcion__menu--click" : "")
        }
        onClick={subMenuClick}
      >
        <div
          className={
            "opcion__boton  " + (props.opciones ? "opcion__boton--click" : "")
          }
        >
          {iconoHtml(props.icono)}
          <Link to={props.ruta} className="opcion__link">
            {props.nombre}
          </Link>
