          ...
          <ul className="lista">
            ...
            >
              <ul className="opcion__subMenu">
                ...
                ></SubOpcionMenu>
                <SubOpcionMenu
                  ruta="producto/categorias"
                  nombre="Lista categorias"
                ></SubOpcionMenu>
                <SubOpcionMenu
                  ruta="producto/ajustes"
            ...
            >
              <ul className="opcion__subMenu">
                ...
                ></SubOpcionMenu>
                <SubOpcionMenu
                  ruta="empleados/nuevos"
                  nombre="No verificados"
                ></SubOpcionMenu>
                <SubOpcionMenu
                  ruta="empleados/token"
