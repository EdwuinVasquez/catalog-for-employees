...
export function CampoVerificado({
  id,
  tipo,
  texto,
  expresion,
  ...
  const typePass = (valor, estado) => {
    if (valor) {
      if (estado) {
        return (
          <BsEye
            className="campoVerificado__password"
  ...
  return (
    <>
      <div className="campoVerificado">
        ...
        <label
          className={
            "campoVerificado__texto  " +
            (datosValido
              ? "campoVerificado__texto--verde"
              : "campoVerificado__texto--rojo") +
            (valueCampo ? "  campoVerificado__texto--vacio" : "  ")
          }
        >
          {texto}
        </label>
