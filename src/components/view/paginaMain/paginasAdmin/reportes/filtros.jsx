...
/*-- Datos del select --*/
const names = ["Pendiente", "Cancelado", "Pago", "Entregado"];

export function FiltrosDatosTabla({
  estadoFiltro,
  valueFechaInicial,
  valueFechaFinal,
  fechaInicial,
  ...
  const manejarCambioFiltroEstado = (event) => {
    ...
    estadoFiltro(
      nuevoFiltro.reduce((acumulador, dato) => `${acumulador} ${dato}`, "")
    );
  };
          ...
          <Dialog open={estadoFiltros} onClose={cerrarEstadoFiltros}>
            ...
            <DialogContent>
              <DialogContentText>
                ...
                procesamiento. <br />
                <strong>Cancelado: </strong>Solicitud de compra rechazada o
                cancelada. <br />
                <strong>Paga: </strong>Solicitud de compra con un pago exitoso.{" "}
                <br />
                <strong>Entregada: </strong>Solicitud de compra la cual ya fue
                entregada. <br />
              </DialogContentText>
              <div>
