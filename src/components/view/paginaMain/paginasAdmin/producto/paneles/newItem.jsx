...
export function ListaItemProducto({
  datosTabla,
  cambiarEstado,
  eliminarItem,
  imagenes,
          ...
          <Typography>
            ...
            <div className="selectBase" style={{ width: "92%" }}>
              <select
                ...
                onChange={(e) => value(e, "tipoContenidoInfo")}
                required=""
                autoComplete="off"
              >
            ...
            >
              <div className="campoVerificado">
                <input
                  ...
                  list=""
                  className="campoVerificado__campo"
                  onChange={(e) => value(e, "contenidoHexaInfo")}
                  type="color"
                  required=""
                  autoComplete="off"
                />
              ...
              >
                <select
                  id="productoEstadoBase"
                  className="selectBase__select"
                  onChange={(e) => value(e, "contenidoImgInfo")}
                  required=""
                  autoComplete="off"
                >
                  <option
                ...
                <i className="selectBase__flecha"></i>
                <label className={"selectBase__texto  "}>
                  Contenido en imagen
                </label>
              </div>
            </div>
            ...
            <div className="selectBase" style={{ width: "92%" }}>
              <select
                id="productoEstadoBase"
                className="selectBase__select"
                onChange={(e) => value(e, "imagenExtraInfo")}
                required=""
                autoComplete="off"
              >
            ...
            <div style={{ width: "92%" }}>
              <BotonSencillo
                texto="Agregar Estilo"
                manejarClik={agregarProducto}
              ></BotonSencillo>
            </div>
          </Typography>
        </AccordionDetails>
