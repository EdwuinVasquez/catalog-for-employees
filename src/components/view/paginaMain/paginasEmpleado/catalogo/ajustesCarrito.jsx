...
import { cerrarAlertaAction as action } from "../../../../../backend/funcioneGenerales.js";
...
export function AjustesCarrito() {
	...
	/*-- Titulos tabla --*/
	const titulosTabla = ["Codigo", "Imagen", "Nombre", "Cantidad", "Valor unitario", "Valor total", "Borrar"]
