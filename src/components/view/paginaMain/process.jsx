...
export function Process() {
  ...
  const { urlBase, setContexUsuario, setContexUsuarioLogin, setCarrito } =
    useDataContex();
  ...
  return (
    <>
      <h1 style={{ cursor: "pointer" }} onClick={() => recargar()}>
        Procesando, recarga la página o presióname en caso de tardar más de{" "}
        {contador} segundos
      </h1>
    </>
  );
