...
import { formatearNumero } from "../../../../backend/funcioneGenerales.jsx";

export function ItemCatalogoBase({
  codigo,
  nombre,
  imagen,
  contenido,
  ...
  const element = (tipo, valor) => {
    if (tipo == 1) {
      ...
      return (
        <>
          <button
            className="itemCatalogoBase__estilo--color"
            style={{
    ...
    <>
      <li className="itemCatalogoBase">
        ...
        <div className="itemCatalogoBase__imagen">
          <LazyLoadImage
            className="itemCatalogoBase__imagen"
            src={`${urlBaseImg}${imagen}`}
            alt=""
            effect="blur"
          />
        </div>
        ...
        <label className="itemCatalogoBase__valor">
          ${formatearNumero(valor)}
        </label>
        <div
          className="itemCatalogoBase__boton  itemCatalogoBase__boton--boton"
