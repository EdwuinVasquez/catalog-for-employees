...
import { cerrarAlertaAction as action, precioVenta, precioBase } from "../../../backend/funcioneGenerales.js";
...
export function CatalogoCardsConfiguracion({ cerrar, actualizar }) {
	...
	const cargarItem = ((activador) => {
		if (idProductosSeleccionado != 0) {
			const productoSelect = datosCompletos.find(valor => valor[0]["nombreItem"].includes(idProductosSeleccionado));
